...
> **Tier 0 production-ready** — local staged CLI, operator-in-the-loop · **1792 tests passing** · checkpoint tag `v0.1.1-tier0`
...
- full pytest baseline: 1792 tests passing（完整回归基线 1792 个测试通过）
...
Baseline: **1792 tests passing**（Windows 下测试请带 `PYTHONIOENCODING=utf-8`）。
