...
> **Tier 0 production-ready** — local staged CLI, operator-in-the-loop · **2414 tests passing** · checkpoint tag `v0.1.2-tier0`
...
- full pytest baseline: 2414 tests passing（完整回归基线 2414 个测试通过）
...
Baseline: **2414 tests passing**（Windows 下测试请带 `PYTHONIOENCODING=utf-8`）。
