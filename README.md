...
> **Tier 0 production-ready** — local staged CLI, operator-in-the-loop · **2301 tests passing** · checkpoint tag `v0.1.2-tier0`
...
- full pytest baseline: 2301 tests passing（完整回归基线 2301 个测试通过）
...
Baseline: **2301 tests passing**（Windows 下测试请带 `PYTHONIOENCODING=utf-8`）。
