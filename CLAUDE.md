...
- 测试：**2962 tests passing**（精确口径：**2961 passed + 1 skipped（收集 2962）**；**本地测试声明**，GitHub 无可见 CI；当前 HEAD `b464a8a`，validated_parent `157914ed`；R3 真实 staged 状态驱动 rollout 新增验收测试基线）
