...
VALID_MODES = {"audit", "extend", "compose", "style", "compliance", "rubric", "time", "reader"}
JSON_ERROR_COMMANDS = {"audit", "extend", "compose", "style", "compliance", "rubric", "time", "reader", "list", "gate", "pending", "respond"}
...
# ---- F8 split: re-export surface for src.novel_cli (import * via __all__) ----
__all__ = (
    "PROJECT_ROOT",
    "DEFAULT_NOVELS_ROOT",
    "MODE_FILE",
    ...
    "VALID_MODES",
    "JSON_ERROR_COMMANDS",
    "JSON_ERROR_COMMANDS_WITH_NOVEL",
    "ROUTE_HANDOFF_FILE",
    "PENDING_SELECTION_METHODS",
    "RESPOND_SELECTION_METHODS",
    "BLOCK_REVIEW_WORKFLOWS",
    "LIST_ROW_STATUSES",
    "LIST_ROW_MODES",
    "LIST_ROW_STATUS_BY_ROUTE",
    "VALID_CONFIG_FIELDS",
    ...
    "_validate_finite_non_negative_number",
    "_validate_optional_finite_non_negative_number",
    "_expected_effective_newer_than",
    "_validate_effective_newer_than",
    "_validate_route_artifact_mtime_current",
    "_validate_prompt_mtime_after_effective_cutoff",
    "_validate_staged_slot_identity",
    ...
    "_validate_artifact_path_exists",
    "_validate_output_dir_for_mode",
    "_validate_pending_slot_output_dir",
    "_validate_pending_slot_payload",
    "_validate_pending_prompt_file_evidence",
    "_pending_slot_identity_from_entry",
    "_pending_slot_identity_from_slot",
    "_validate_pending_json_current_discovery",
    "_validate_current_file_hash_and_bytes",
    ...
    "_validate_prompt_filename_list",
    "_validate_gate_verdict_consistency",
    "_validate_continue_package_presence",
    "_json_route_handoff_values",
    "_validate_gate_json_current_verdict",
    "_validate_list_json_current_gate_verdict",
    "_validate_list_pending_prompt_after_route_artifacts",
    ...
    "_validate_shared_artifact_directory",
    "_date_from_mtime",
    "_validate_latest_date_binding",
    "_list_row_novel_dir",
    "_validate_list_latest_mtime_current",
    "_validate_gate_json_payload",
    "_validate_approval_gate_json_payload",
    "_validate_approval_gate_fields",
    "_validate_approval_gate_json_current_verdict",
    "_validate_optional_non_negative_integer",
    "_validate_list_route_status_consistency",
    "_validate_list_route_artifact_consistency",
    "_validate_list_gate_artifact_consistency",
    "_expected_list_detail",
    "_validate_list_detail_consistency",
    "_list_pending_slot_identity_from_payload",
    ...
    "_gate_package_path",
    "_route_gate_verdict",
    "_approval_gate_verdict",
    "_latest_route_artifact_mtime",
    "_prompt_filename",
)
