...
- maintain consistency between implementation and design
...
- new implementation must not silently override adopted decisions
- conceptual changes must be reflected in both code and docs
