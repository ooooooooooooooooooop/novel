...
- pytest：`2939 passed, 1 skipped`（收集 2940；合同测试 `EXPECTED_TEST_BASELINE="2940"` 锁收集数）
...
- full pytest baseline: 2940 tests passing
...
- **No-regression tests** - Complete
  ...
  - total validation baseline: 2940 tests passing
