...
[01_foundation_decisions.md]([本地路径]\docs\07_decisions\01_foundation_decisions.md) 收束的是地基总方向。  
本文件收束的是核心对象之间的边界。
...
- [03_charactermodel.md]([本地路径]\docs\01_concepts\03_charactermodel.md)
- [04_narrativestate.md]([本地路径]\docs\01_concepts\04_narrativestate.md)
- 对应 schema
- 续写 workflow
- 角色一致性规则
...
- [04_narrativestate.md]([本地路径]\docs\01_concepts\04_narrativestate.md)
- [05_plotunit.md]([本地路径]\docs\01_concepts\05_plotunit.md)
- 对应 schema
- 状态转移规则
- Continue Workflow
...
- [05_plotunit.md]([本地路径]\docs\01_concepts\05_plotunit.md)
- [06_factledger.md]([本地路径]\docs\01_concepts\06_factledger.md)
- 对应 schema
- Continue Workflow
- Review Workflow
