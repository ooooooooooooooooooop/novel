...
## 2026-06-16 executable schema

The current runtime model intentionally uses a compact `ReviewReminder`
contract:
...
```json
{
  ...
  "trigger_condition": "2 PlotUnits without payoff",
...
The runtime validates `escalation_issue_type` against the family matrix in
`docs/07_decisions/11_reviewreminder_escalation_matrix.md`.
