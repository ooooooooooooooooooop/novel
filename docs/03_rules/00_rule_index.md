...
- `03_rules/11_book_naming_rules.md`
...
## 3.11 `11_book_naming_rules.md`
### 作用
定义作品命名（书名）方法论与判定标准，供每次新作品命名复用（任何题材）。

### 主要回答
- 书名的真实职责由什么决定（平台流量机制：吸量 vs 预期管理）
- 不同题材的书名"语法"有何不同（词汇 / 结构 / 红海）
- 怎么从作品内核提炼候选并决策
- 撞名 / 合规红线与核查清单是什么

### 核心服务对象
- `WorkSpec`（命名是规格层人工 / LLM 决策，`WorkSpec` 无 `title` 字段）

### 与 09 / 10 的边界
- 09 / 10：正文 / 角色层知识先验
- 11：作品规格层命名先验；只沉淀方法论与公开畅销数据，不写具体作品名（隐私红线）
