...
- release record: `docs/00_project/releases/tier0-release.json` (passes the single combined validation command at the current full-pytest baseline 2733)
...
- No-regression tests: 2733 tests passing
