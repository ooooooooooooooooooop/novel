...
- 测试基线：**3018 tests passing**（精确口径：**3017 passed + 1 skipped（收集 3018）**；**本地测试声明**，GitHub 无可见 CI；本地上次基线 2947 passed 为 2026-08-17 R0–R9 事迹）。
...
- No-regression tests: 3018 tests passing（精确口径：3017 passed + 1 skipped，收集 3018；本地测试声明，GitHub 无可见 CI）
