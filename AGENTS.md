...
- release record: `docs/00_project/releases/tier0-release.json` (passes the single combined validation command at the current full-pytest baseline 2129)
...
- No-regression tests: 2129 tests passing
