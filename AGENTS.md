...
- 测试基线：**2982 tests passing**（精确口径：**2981 passed + 1 skipped（收集 2982）**；**本地测试声明**，GitHub 无可见 CI；本地上次基线 2947 passed 为 2026-08-17 R0–R9 事迹）。
...
- No-regression tests: 2982 tests passing（精确口径：2981 passed + 1 skipped，收集 2982；本地测试声明，GitHub 无可见 CI）
