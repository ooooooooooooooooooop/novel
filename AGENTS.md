...
- release record: `docs/00_project/releases/tier0-release.json` (passes the single combined validation command, expected baseline 1444)
...
- No-regression tests: 1444 tests passing
