...
- 测试基线：2902 passed, 1 skipped（收集 2903；「2903 tests passing」为收集数表述）。
...
- release record: `docs/00_project/releases/tier0-release.json` (passes the single combined validation command at the current full-pytest baseline 2903)
...
- No-regression tests: 2903 tests passing
